...
const Sidebar = () => {
  const { isDrawerOpen, setIsDrawerOpen } = useContext(SidebarContext); // Accede a isDrawerOpen y setIsDrawerOpen
        ...
        <div className="py-4 overflow-y-auto">
          <ul className="space-y-2 font-medium">
            <li>
              ...
              >
                <RxDashboard className="w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900" />
            ...
            <li>
              ...
              >
                <PiSignInBold className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900" />
