...
const ListadoProyecto = () => {
  ...
  const { proyectos, obtenerProyectos, proyectoActual } = proyectosContext; // Accede a proyectoActual aquí
        ...
        <table className="w-full text-sm text-left rtl:text-right text-gray-500">
          ...
          <tbody>
            {proyectos.map((proyecto) => (
              <tr key={proyecto.id} className="bg-white border-b">
                ...
                <td className="px-6 py-4">
                  <a
                    href="#"
                    onClick={(e) => seleccionarProyecto(e, proyecto.id)}
